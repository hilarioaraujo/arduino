...
///////////////////////////////////   Sistema de Controlo PD  /////////////////////////////
float //constante do sistema de controlo K
  Kp=2,
  Td=15,
...
///////////////////////////////////   CALIBRACAO   /////////////////////////////
   if (state==0){
        Serial.println("\A recolher os de valores do gyro");
        meansensors();
        state++;
        delay(1000);
    }
...
///////////////////////////////////   CALCULOS PARA O ALVO   /////////////////////////////
        ...
        erro=alvo_angulo-yaw;
        



        T = ((millis() - tdecorrido))/1000.0;       //calcula a diferença em segundos entre um loop
        ...
        dist_alvo=80; // distancia desde a posição atual do tanque até ao alvo
...
///////////////////////////////////   Input's para os motores   /////////////////////////////        
        ...
        if (dist_alvo<=dist_cheg){ // caso o Tanque tenha chegado ao alvo, colocar o motores em freio
                    ...
                    vl=v_media-(w/(2*Kp));  //cálculo do módulo da velocidada da lagarta da esquerda
                    vr=v_media+(w/(2*Kp));  //cálculo do modulo da velocidade da lagarta da direita
